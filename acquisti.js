...
function onRfqSelectChange() {
  ...
  if (!p) {
    ...
    document.getElementById('rfq-scadenza').value = '';
  ...
  document.getElementById('rfq-scadenza').value = p.rfqScadenza || '';
...
function saveRfqFieldsAndPreview() {
  ...
  updatePratica(id, {
    ...
    rfqScadenza: document.getElementById('rfq-scadenza').value,
...
function renderRfqPreview() {
  ...
  const deadline = p.rfqScadenza || '[Data Scadenza]';
...
Inviare il riscontro entro il: ${deadline}.
    ...
    try {
      ...
      rows.forEach(row => {
        ...
        const pratica = {
          ...
          fornitore: String(fornitore), fornitoreEmail: '', rfqScadenza: '', rfqNote: '',
